...
- (void)viewDidLoad {
    ...
    _layer.bounds = CGRectMake(0, 0, 60, 40);
...
-(void)translatonAnimation:(CGPoint)location{
    ...
    //    [basicAnimation.toValue pointValue];
    //3设置其他动画属性
    basicAnimation.duration=5.0;
    //    basicAnimation.repeatCount=HUGE_VALF;//设置重复次数
...
-(void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    //开启事务  关闭隐式动画需要用到动画事务CATransaction
    [CATransaction begin];
    //禁用隐式动画
